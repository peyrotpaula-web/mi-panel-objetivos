...
# =========================================================
    ...
    if u45 and u53:
        try:
            ...
            df53 = df53_raw.copy()
            df53['KEY'] = df53[c_v_53].astype(str).str.upper()
            ...
            ranking_display = ranking[['Rank_Icon', 'Asesor_Oficial', 'VN', 'VO', 'PDA', 'ADJ', 'VE', 'TOTAL', 'TOMA_VO', 'Sucursal']].rename(columns={'Rank_Icon': 'Ranking', 'Asesor_Oficial': 'Asesor'})
