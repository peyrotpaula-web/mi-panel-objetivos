...
# =========================================================
# OPCIÓN 2: RANKING DE ASESORES (VERSIÓN ESTABLE Y ROBUSTA)
# =========================================================
    ...
    if u45 and u53:
        try:
            ...
            # Función para limpiar nombres: quita espacios extras, puntos y pasa a MAYÚSCULAS
            def limpiar_texto(t):
