...
# 1. CONFIGURACIÓN Y ESTILOS CRÍTICOS PARA PDF
st.set_page_config(page_title="Dashboard Objetivos", layout="wide")

st.markdown("""
    <style>
    /* Forzar que el contenido sea visible en la impresión */
    @media print {
        body {
        ...
        /* Asegurar que los gráficos ocupen el ancho y no se corten */
...
if uploaded_file:
    try:
        ...
        # Gráficos con configuración estática para mejorar impresión
        ...
        st.components.v1.html("""
            ...
            <button onclick="imprimir()" style="
                ...
                font-weight: bold;
            ">
                ✅ EL PANEL ESTÁ LISTO: HACER CLIC AQUÍ PARA DESCARGAR PDF
            </button>
        """, height=100)
